...
from client.modules import Life, Joke, Time, Gmail, Music, News, Weather
...
class TestModules(unittest.TestCase):
    ...
    def runConversation(self, query, inputs, module):
        """Method for spoofing conversation.
        Arguments:
    ...
    def testMusic(self):
        ...
        outputs = self.runConversation(query, inputs, Musxi)
        self.assertTrue("OK! Playing music" in outputs[1])
